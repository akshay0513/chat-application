  ...
  <div class="w-64 bg-gray-900 text-gray-200 h-screen p-4 flex flex-col">
    ...
    <div class="mt-4 flex justify-between items-center">
      ...
      <label class="flex items-center cursor-pointer">
        ...
        <div
          class="toggle-bg bg-gray-600 border-2 border-gray-600 h-6 w-10 rounded-full flex items-center p-1"
        >
          <div
            class="toggle-dot bg-white h-4 w-4 rounded-full shadow-md transform"
          ></div>
        </div>
        <span class="ml-2 text-gray-400 text-sm">Dark</span>
      </label>
    </div>
  </div>
</template>
